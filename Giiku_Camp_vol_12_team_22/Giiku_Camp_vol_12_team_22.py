...
class State(rx.State):
    ...
    head_options = ["僕の", "駆け出し", "新しい", "大人の", "スペシャル", "新・", "ふつうの", "自称", "Dr.", "新しい", 'しかのこ', '影薄め']
    middle_options = ["ヒーロー", "学校", "研究", "明太子", "虎ノ門", "Youtube", "無課金", "サッカー", "キーボード", "ライブ", 'のこのこ', '寿司', 'まんまる']
    tail_options = ["部", ".txt", "同好会", "（仮）", "アカデミア", "中毒", "のリーダーズ", "のために", "w", "・改", 'こしたんたん', 'エンジニア', 'チャレンジャーズ']
